...
const defs: Record<EffectId, ParamControl[]> = {
  ...
  fractalGlass: [
    ...
    { key: "count", label: "Count", type: "slider", min: 4, max: 40, default: 12 },
    { key: "blurAmount", label: "Blur", type: "slider", min: 0, max: 30, default: 12 },
    { key: "opacity", label: "Opacity", type: "slider", min: 0, max: 100, default: 85 },
    { key: "gradientStrength", label: "Gradient", type: "slider", min: 0, max: 100, default: 70 },
    { key: "variation", label: "Variation", type: "slider", min: 0, max: 100, default: 25 },
    { key: "showEdges", label: "Pane Edges", type: "toggle", default: true },
  ],
  glass: [
    { key: "rings", label: "Rings", type: "slider", min: 3, max: 40, default: 20 },
    { key: "spiralTurns", label: "Rotation (°)", type: "slider", min: 0, max: 180, default: 90 },
